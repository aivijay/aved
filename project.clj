(defproject aved "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "aved.core/on-figwheel-reload"}

                :compiler {:main aved.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/aved.js"
